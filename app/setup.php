...
add_action('after_setup_theme', function () {
     ...
     */
    register_nav_menus([
        'primary_navigation' => __('Primary Navigation', 'mooiwerk-breda-theme'),
    ]);
...
add_action('widgets_init', function () {
    ...
    register_sidebar([
        'name' => __('Primary', 'mooiwerk-breda-theme'),
        'id' => 'sidebar-primary',
    ] + $config);
    $config = [
    ...
    register_sidebar([
        'name' => __('Footer Column 1', 'mooiwerk-breda-theme'),
        'id' => 'sidebar-footer-column-1',
    ] + $config);
    register_sidebar([
        'name' => __('Footer Column 2', 'mooiwerk-breda-theme'),
        'id' => 'sidebar-footer-column-2',
    ] + $config);
    register_sidebar([
        'name' => __('Footer Column 3', 'mooiwerk-breda-theme'),
        'id' => 'sidebar-footer-column-3',
    ] + $config);
    register_sidebar([
        'name' => __('Footer Column 4', 'mooiwerk-breda-theme'),
