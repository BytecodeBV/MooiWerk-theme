<div class="card shadow border-light blog-card flex-md-row mb-4 box-shadow h-md-250">
    <img class="card-img-left blog-card__image flex-auto d-block" src="{{ get_the_post_thumbnail_url()? get_the_post_thumbnail_url(null, [200, 250]) : '//placehold.it/200x250' }}" alt="{{__('Thumbnail', 'mooiwerk-breda-theme')}}">
    <div class="card-body blog-card__body d-flex flex-column align-items-start">
        ...
        <a href="{{ get_permalink() }}" class="blog-card__link">{{__('bekijk >', 'mooiwerk-breda-theme')}}</a>
    </div>
</div>
